...
- **Важно:** из-за особенностей медиа-запросов в верстке проверять правильность отображения на малых размерах экрана только с включенной эмуляцией тачскрина или на физических устройствах (а еще лучше — сперва проверить [здесь](https://hover-pointer-media-query.glitch.me/), действительно ли ваш текущий браузер ведет себя соответственно устройству, которому пытается подражать).
### Примечания
